...
- **Polymorphic Associations**: `memory_relations` can now link Memory $\rightarrow$ Entity, Entity $\rightarrow$ Entity, or Memory $\rightarrow$ Memory.
...
3.  **Validation**: All extracted predicates are strictly validated against our `RelationType` taxonomy.
